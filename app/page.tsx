...
export default function page() {
  ...
  <div className="w-full max-w-lg px-4 sm:max-w-2xl md:max-w-3xl sm:scale-100 transition-transform duration-300 ease-in-out">
  ...
  {/* Image Section */}
  <div className="w-full max-w-sm scale-110 sm:scale-100 transition-transform duration-300 ease-in-out">
    <img
      src="./about.png"
      alt="About"
  ...
  {/* Text Section */}
  <div className="w-full max-w-2xl text-center md:text-left scale-110 sm:scale-100 transition-transform duration-300 ease-in-out">
    ...
    <div className="flex flex-col lg:flex-row items-center justify-center gap-0 lg:gap-4 px-2 w-full">
  <img src="./image1.png" className="w-3/4 sm:w-2/3 md:w-1/2 lg:w-1/3 h-auto" />
  <div className="w-full sm:w-1/2 md:w-1/3 h-auto flex justify-center items-center">
   <div className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl scale-120 md:scale-100 py-8 text-center text-xl text-purple-700 font-bold">PLAY WITH ME
  <Tictactoe />
</div>

  </div>
  <img src="./image3.png" className="w-3/4 sm:w-2/3 md:w-1/2 lg:w-1/3 h-auto" />
</div>

<div className="relative flex flex-col md:flex-row justify-center items-center gap-6 px-4 py-24">
  ...
  {/* SONG COMPONENT */}
  <div className="w-3/4 max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl flex justify-center items-center scale-110 sm:scale-100 transition-transform duration-300 ease-in-out">
    <Song />
  </div>
